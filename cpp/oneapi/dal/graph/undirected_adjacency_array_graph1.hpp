...
class undirected_adjacency_array_graph1 {
public:
    using graph_type =
        undirected_adjacency_array_graph1<VertexValue, EdgeValue, GraphValue, IndexType, Allocator>;
    ...
    /// Constructs an empty undirected_adjacency_array_graph1
    undirected_adjacency_array_graph1();

    /// Constructs an empty undirected_adjacency_array_graph1
    virtual ~undirected_adjacency_array_graph1() = default;

    /// Move constructor for undirected_adjacency_array_graph1
    undirected_adjacency_array_graph1(undirected_adjacency_array_graph1 &&graph);

    /// Copy constructor for undirected_adjacency_array_graph1
    undirected_adjacency_array_graph1(const undirected_adjacency_array_graph1 &graph);

    /// Constructs an empty undirected_adjacency_array_graph1 with specified graph properties
    /// and allocator
    undirected_adjacency_array_graph1(const graph_user_value_type &graph_user_value,
                                      allocator_type allocator = allocator_type()){};

    /// Constructs an empty undirected_adjacency_array_graph1 with move graph properties and
    /// allocator
    undirected_adjacency_array_graph1(graph_user_value_type &&graph_user_value,
                                      allocator_type allocator = allocator_type()){};

    undirected_adjacency_array_graph1(size_t vertex_count,
                                      const VertexValue *vertex_values,
                                      allocator_type allocator = allocator_type());

    /// Copy operator for undirected_adjacency_array_graph1
    undirected_adjacency_array_graph1 &operator=(const undirected_adjacency_array_graph1 &graph);

    /// Move operator for undirected_adjacency_array_graph1
    undirected_adjacency_array_graph1 &operator=(undirected_adjacency_array_graph1 &&graph);
    using pimpl =
        oneapi::dal::detail::pimpl<detail::undirected_adjacency_array_graph1_impl<VertexValue,
                                                                                  EdgeValue,
                                                                                  GraphValue,
                                                                                  IndexType,
                                                                                  Allocator>>;
...
undirected_adjacency_array_graph1<VertexValue, EdgeValue, GraphValue, IndexType, Allocator>::
    undirected_adjacency_array_graph1(size_t vertex_count,
        ...
        : undirected_adjacency_array_graph1() {
    auto &layout = detail::get_impl(*this);
    layout->_allocator = allocator;
    detail::some_construct(layout, vertex_count, vertex_values);
}
...
undirected_adjacency_array_graph1<VertexValue, EdgeValue, GraphValue, IndexType, Allocator>::
    undirected_adjacency_array_graph1()
        : impl_(new detail::undirected_adjacency_array_graph1_impl<VertexValue,
                                                                   EdgeValue,
                                                                   GraphValue,
                                                                   IndexType,
                                                                   Allocator>) {}
...
undirected_adjacency_array_graph1<VertexValue, EdgeValue, GraphValue, IndexType, Allocator>
    &undirected_adjacency_array_graph1<VertexValue, EdgeValue, GraphValue, IndexType, Allocator>::
    operator=(const undirected_adjacency_array_graph1 &graph) {
    if (&graph != this) {
        const auto &layout = detail::get_impl(graph);
...
undirected_adjacency_array_graph1<VertexValue, EdgeValue, GraphValue, IndexType, Allocator>
    &undirected_adjacency_array_graph1<VertexValue, EdgeValue, GraphValue, IndexType, Allocator>::
    operator=(undirected_adjacency_array_graph1 &&graph) {
    if (&graph != this) {
        auto &layout = detail::get_impl(graph);
